...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.spaces.devframework.land","artifactId":"where2","serviceNamespace":"server-workload","projectName":"where2","workloadNamespace":"server-workload","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"server","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input16731299571164210599, --data-values-file, /tmp/accelerator-options8373076324284220507.json, --output-files, /tmp/ytt-output14408762252666284229]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.spaces.devframework.land","artifactId":"where2","serviceNamespace":"server-workload","projectName":"where2","workloadNamespace":"server-workload","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"server","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12389753755161268406, --data-values-file, /tmp/accelerator-options2727591983589815134.json, --output-files, /tmp/ytt-output5848835375111532375]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.spaces.devframework.land","artifactId":"where2","serviceNamespace":"server-workload","projectName":"where2","workloadNamespace":"server-workload","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"server","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input16141839311386157935, --data-values-file, /tmp/accelerator-options13528919343541399022.json, --output-files, /tmp/ytt-output3308865654626264855]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.spaces.devframework.land","artifactId":"where2","serviceNamespace":"server-workload","projectName":"where2","workloadNamespace":"server-workload","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"server","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7524480673931962109, --data-values-file, /tmp/accelerator-options17173231333836517490.json, --output-files, /tmp/ytt-output9672149076696992047]
